...
public final class AssetTransfer implements ContractInterface {
    ...
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context context, final String assetId, final String newassetId, final String newOwner){
        Asset oldAsset = ReadAsset(context, assetId);
        return CreateAsset(context, newassetId, oldAsset.getColor(), oldAsset.getSize(), newOwner, oldAsset.getAppraisedValue());
    }
}
